...
class ArrayHelper
{
     ...
     *     $groups is not defined, the array element will be discarded. Otherwise, if $groups is specified, array element will be added to the result
     *     array without any key.
     *
     ...
     *     `SORT_FLAG_CASE`. Please refer to [PHP manual](http://php.net/manual/en/function.sort.php) for more details. When sorting by multiple keys
     *     with different sort flags, use an array of sort flags.
     *
